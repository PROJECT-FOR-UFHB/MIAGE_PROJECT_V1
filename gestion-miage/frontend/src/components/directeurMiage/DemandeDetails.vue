<template>
  <main class="bg-gray-100 min-h-screen pt-10 px-4 pb-10">
    <div class="max-w-6xl mx-auto bg-white rounded shadow p-6">
      <h2 class="text-xl font-semibold mb-6 text-center sm:text-left">Demande à signer</h2>
      ...
      <div v-else>
        ...
        <div class="mb-4">
          ...
          <textarea v-model="comment" rows="3"
            ...
            placeholder="Saisissez un commentaire (ex: paiement confirmé)"></textarea>
        </div>

        <div class="flex justify-end space-x-4">
          <button @click="valider" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
            ✅ Signer
          </button>
        </div>
      </div>
